...
class Query(models.Model):
    id=models.IntegerField(unique=True,primary_key=True,auto_created=True,verbose_name="id")
...
class Image(models.Model):
    ...
    user=models.ForeignKey(User,blank=True,null=True,on_delete=models.CASCADE,related_name='%(class)s_user2')
